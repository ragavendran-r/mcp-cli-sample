...
from core.llm_service import LLMMessage, LLMService
...
class Chat:
    def __init__(self, claude_service: LLMService, clients: dict[str, MCPClient]):
        self.claude_service: LLMService = claude_service
    ...
    async def run(
        ...
        while True:
            response: LLMMessage = self.claude_service.chat(
